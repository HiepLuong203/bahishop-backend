...
router.post("/:product_id/images", authenticateToken, upload.array("image_url", 10), ProductImageController.createProductImages);

router.put("/:image_id", authenticateToken, upload.single("image_url"), ProductImageController.updateProductImage);
