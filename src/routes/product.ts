...
router.post("/", uploadImages.single("image_url"), ProductController.createProduct);
...
router.put("/:product_id", authenticateToken, uploadImages.single("image_url"), ProductController.updateProduct);
